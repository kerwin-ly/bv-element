...
```javascript
import Vue from 'vue';
import ElementUI from 'bv-element';
import 'bv-element/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'bv-element';
import App from './App.vue';
...
```js
import Vue from 'vue';
import Element from 'bv-element';
