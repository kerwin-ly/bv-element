...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'bv-element/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'bv-element/src/utils/util';
